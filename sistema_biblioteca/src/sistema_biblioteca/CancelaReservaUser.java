...
public class CancelaReservaUser extends JFrame {
	...
	public CancelaReservaUser(String NumeroReserva, int linha){
		...
		this.btnSim.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				reserva.delete();
				JTableReservaUser.reloadJTable(JTableReservaUser.jPanelTabela);
				dispose();
			}
		});
